...
class Config(context: Context) : BaseConfig(context) {
    ...
    var callRecordingSource: String
        get() = prefs.getString(CALL_RECORDING_SOURCE, RECORDING_SOURCE_ENVIRONMENT) ?: RECORDING_SOURCE_ENVIRONMENT
        set(value) = prefs.edit().putString(CALL_RECORDING_SOURCE, value).apply()

    var callRecordingFolderUri: String
        get() = prefs.getString(CALL_RECORDING_FOLDER_URI, "") ?: ""
        set(value) = prefs.edit().putString(CALL_RECORDING_FOLDER_URI, value).apply()
}
